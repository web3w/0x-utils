...
export type ExcludeBaseOrder = Exclude<keyof SignedOrder, keyof BaseOrder>

// export typeof  Exclude<BaseOrder,SignedOrder>
...
export type AssetProxyKey = keyof typeof AssetProxyId
...
export type AssetDataAndType = AssetData & { assetProxyKey: AssetProxyKey }
