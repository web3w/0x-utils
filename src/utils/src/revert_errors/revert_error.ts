 ...
 */
export function registerRevertErrorType(revertClass: RevertErrorType, force = false): void {
 ...
 */
export function decodeBytesAsRevertError(bytes: string | Buffer, coerce = false): RevertError {
 ...
 * @return A RevertError object.
 */
export function decodeThrownErrorAsRevertError(error: Error, coerce = false): RevertError {
...
export abstract class RevertError extends Error {
   ...
   * @return A RevertError object.
   */
  public static decode(bytes: string | Buffer | RevertError, coerce = false): RevertError {
   ...
   */
  public static registerType(revertClass: RevertErrorType, force = false): void {
