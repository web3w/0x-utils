...
import { AbiDecoder, addressUtils, BigNumber, intervalUtils, providerUtils } from '../utils';
...
export class Web3Wrapper {
     ...
     */
    public isEelementWeb3Wrapper = true;
    ...
    public async signMessageByPersonalAsync(address: string, message: string): Promise<string> {
        assert.isETHAddressHex('address', address);
        assert.isString('message', message); // TODO: Should this be stricter? Hex string?
        const signData = await this.sendRawPayloadAsync<string>({
...
//
// const signatureHex = result.result
//
// signature = signatureUtils.convertToSignatureWithType(signatureHex, SignatureType.EIP712)
// console.log('712 signature', signature)
//
// const orderInfo = await this.exchange.getOrderInfo(data, this.signer)
// console.log(orderInfo)
//
// const isValidOrderSignature = await this.exchange.isValidOrderSignature(order, signature)
// console.log('isValidOrderSignature ', isValidOrderSignature)
// })
    /**
